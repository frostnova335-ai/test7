...
const dashboardDescriptions: Record<number, string> = {
  ...
  26: 'Discover high-impact automation opportunities by analyzing volume and process complexity. Prioritize the right transformations to reduce effort and maximize operational impact.',
