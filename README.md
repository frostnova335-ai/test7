  ...
  return (
    <div className="view active" style={{ flexDirection: "column", height: "100%" }}>
      ...
      <div className="suggestion-row">
        <span style={{ fontSize: 10, color: "var(--muted)", marginRight: 4, whiteSpace: "nowrap", paddingTop: 6 }}>
          Try:
        </span>
        {suggestions.map((s) => (
          <div key={s} className="suggest-chip" onClick={() => onUseQuery(s)}>{s}</div>
        ))}
      </div>
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar { background: var(--cream); border-right: 1px solid var(--border); padding: 20px 0; overflow-y: auto; }
        ...
        .search-title { font-family: 'Instrument Serif', serif; font-size: 28px; color: var(--paper); margin-bottom: 6px; font-style: italic; }
        .search-sub { font-size: 12px; color: rgba(255,255,255,0.4); margin-bottom: 22px; }
        .search-box-wrap { position: relative; }

        .main-search { width: 100%; background: rgba(255,255,255,0.07); border: 1.5px solid rgba(255,255,255,0.2); border-radius: 10px; padding: 16px 120px 16px 18px; color: #fff; font-family: 'DM Mono', monospace; font-size: 14px; outline: none; transition: border-color 0.2s; line-height: 1.5; }
        ...
        .suggestion-row { display: flex; gap: 10px; padding: 18px 36px; border-bottom: 1px solid var(--border); overflow-x: auto; background: var(--cream); flex-shrink: 0; }
        ...
        .ai-summary { background: linear-gradient(135deg,#0a0a0f 0%,#1a1a2e 100%); border: 1px solid rgba(232,74,46,0.3); border-radius: 10px; padding: 18px; margin-bottom: 20px; position: relative; overflow: hidden; }
        ...
        .tag { font-size: 10px; padding: 2px 8px; border-radius: 4px; border: 1px solid var(--border); color: var(--muted); background: var(--cream); }
        ...
        .moment-time { font-size: 10px; background: var(--ink); color: var(--paper); padding: 2px 7px; border-radius: 4px; flex-shrink: 0; margin-top: 1px; }
        ...
        .pattern-builder { background: var(--ink); border-radius: 10px; padding: 20px; margin-bottom: 20px; }
