...
const Definitions = lazy(
  () =>
    import(
      /* webpackChunkName: "Definitions" */ 'src/pages/Definition/Definitions'
    ),
);

const CcaasArchitecture = lazy(
  () =>
    import(
      /* webpackChunkName: "CcaasArchitecture" */ 'src/pages/CcaasArchitecture'
    ),
);

const StrategyRoadmap = lazy(
  () =>
    import(
      /* webpackChunkName: "StrategyRoadmap" */ 'src/pages/StrategyRoadmap'
    ),
);

const AskAnalytics = lazy(
  () => import(/* webpackChunkName: "AskAnalytics" */ 'src/pages/AskAnalytics'),
);
...
const userRoles = isUserWithPermissionsAndRoles(user) ? user.roles : undefined;
const canReadAskAnalytics = findPermission(
  'can_read',
  'AskAnalytics',
  userRoles,
);
const canReadStrategyRoadmap = findPermission(
  'can_read',
  'StrategyRoadmap',
  userRoles,
);
...
export const routes: Routes = [
  ...
  {
    path: '/insightshub/dashboard/:idOrSlug/',
    Component: Dashboard,
  },
  {
    path: '/insightshub/definition/',
    Component: Definitions,
  },
  {
    path: '/insightshub/architecture/',
    Component: CcaasArchitecture,
  },

  {
    path: '/insightshub/search',
    Component: Search,
  },
  // {
  //   path: '/insightshub/strategy-roadmap/',
  //   Component: canReadStrategyRoadmap ? StrategyRoadmap : Home,
  // },
  // {
  //   path: '/insightshub/ask-analytics/',
  //   Component: canReadAskAnalytics ? AskAnalytics : Home,
  // },
  {
    path: '/chart/add',
...
if (isFeatureEnabled(FeatureFlag.TaggingSystem)) {
  routes.push({
    path: '/insightshub/all_entities/',
    Component: AllEntities,
  });
  routes.push({
    path: '/insightshub/tags/',
    Component: Tags,
  });
}
